            ...
            <div className="w-full px-4 md:w-1/2">
              <div className="lg:pl-20">
                ...
                <div className="py-6 mb-6 border-t border-b border-gray-200 dark:border-gray-700">
                  ...
                  <p className="mt-2 text-sm text-blue-500 dark:text-blue-200">
                    <span className="text-gray-600 dark:text-gray-400">
                      Shipping in 4 to 5 business days after purchase
                    </span>
                  </p>
                </div>
                ...
                <div className="flex flex-wrap items-center mb-6">
                  ...
                  <a className="w-full px-4 py-3 text-center text-blue-600 bg-blue-100 border border-blue-600 dark:hover:bg-gray-900 dark:text-gray-400 dark:border-gray-700 dark:bg-gray-700 hover:bg-blue-600 hover:text-gray-100 lg:w-1/2 rounded-xl">
                    Add to cart
                  </a>
                </div>
